// 中国节假日 —— 由 cn-holiday Skill 的查询逻辑移植为潮衡内置插件。
    ...
    try {
      ...
      root.innerHTML = `<div class="ch-wrap">
        ...
        <div class="ch-grid">
          ...
          <section class="ch-card"><div class="ch-title">规则说明</div><div class="ch-muted">调休上班日会覆盖普通周末，不会误算成休息日。缺少年份时才联网读取；已获取的数据会缓存到潮衡本地数据中。</div><div class="ch-source">数据源：NateScarlet/holiday-cn · 原始依据为国务院办公厅放假通知</div></section>
        </div>
