...
val tideProject = rootProject.projectDir.resolve("../../tidebalance")
...
android {
    namespace = "com.yile.tidebalance"
    compileSdk = 37
    defaultConfig {
        applicationId = "com.yile.tidebalance"
        minSdk = 26
        targetSdk = 37
        // Existing TideBalance 0.1.0 installations use version code 1000.
        versionCode = 1001
        versionName = "0.1.0"
    ...
    buildTypes {
        release {
            signingConfig = signingConfigs.getByName("tidebalanceRelease")
