// Added by TideBalance: embeds the upstream Compose App in the host's native client area.
...
fun runTideBalanceHost(parentHandle: Long) {
    ...
    SwingUtilities.invokeLater {
        ...
        println("TIDEBALANCE_READY")
        System.out.flush()
        thread(name = "tidebalance-host-control", isDaemon = true) {
            try {
